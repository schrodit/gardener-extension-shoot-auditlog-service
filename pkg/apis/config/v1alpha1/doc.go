...
// +k8s:conversion-gen=github.com/gardener/gardener-extension-shoot-auditlog-service/pkg/apis/config
...
// +groupName=shoot-auditlog-service.extensions.config.gardener.cloud
package v1alpha1
