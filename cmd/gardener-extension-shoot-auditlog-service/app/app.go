...
import (
	...
	serviceinstall "github.com/gardener/gardener-extension-shoot-auditlog-service/pkg/apis/service/install"
	"github.com/gardener/gardener-extension-shoot-auditlog-service/pkg/controller"
	"github.com/gardener/gardener-extension-shoot-auditlog-service/pkg/controller/healthcheck"
...
func NewServiceControllerCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "shoot-auditlog-controller-manager",
		Short: "Auditlog Service Controller manages components which provide certificate services.",
...
func (o *Options) run(ctx context.Context) {
	...
	ctrlOptions := o.auditlogOptions.Completed()
	ctrlOptions.ApplyHealthCheckConfig(&healthcheck.DefaultAddOptions.HealthCheckConfig)
	ctrlOptions.Apply(&controller.DefaultAddOptions.ServiceConfig)
	...
	_, _, err = o.webhookOptions.Completed().AddToManager(mgr)
	if err != nil {
